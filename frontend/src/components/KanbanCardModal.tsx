        ...
        <div className="flex-1 overflow-y-auto px-6 pt-3 pb-5 space-y-1">
          ...
          <div className="grid grid-cols-[7rem_1fr] gap-y-3 gap-x-3 text-sm">
            ...
            {card.priorityLockedAt && !isNew ? (
              <div className="flex items-center gap-1.5 text-sm text-gray-500 pt-1" title="Prioriteten är låst — kortet har påbörjats och tokenvärdet kan inte längre ändras">
