...
// Same mark as /public/img/goodtribes-mark.svg, inlined so it can be tinted
// via CSS and layered behind the hero text (z-index:-1) without an extra
// image request. Colors are the mark's real originals — never recolored to
...
export default async function HomeHero({
  ...
  return (
    <div className={`${homeSansFont.className} relative`} style={{ overflow: "hidden" }}>
      <div className="max-w-[1160px] mx-auto px-8 relative" style={{ padding: "76px 32px 26px" }}>
        <WatermarkLogo />
        {canEdit && (
          <Link
