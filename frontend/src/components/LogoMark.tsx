// The GoodTribes icon mark, inlined so it can render at any size without an
// extra image request. Same shapes as /public/img/goodtribes-mark.svg (the
// icon-only crop of /public/img/goodtribes-logo.svg). Colors are the mark's
// real originals — never recolored to a brand accent, per explicit design
// direction. Shared between the hero and the site header so both use the
// exact same graphic.
