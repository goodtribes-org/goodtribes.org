      ...
      <div className="hidden md:flex items-center gap-4 text-sm">
        ...
        <div ref={sandboxRef} className="relative">
          <button
            ...
            className="flex items-center gap-1 rounded-full ring-2 ring-orange-500 px-3 py-1 font-bold text-watermelon hover:bg-watermelon hover:text-white transition-colors whitespace-nowrap"
          >
            {t("sandbox")}
        ...
        <div className="absolute top-full left-0 right-0 bg-white border-b border-muted-teal md:hidden z-50 shadow-md">
          <nav className="max-w-6xl mx-auto px-6 py-3 flex flex-col">
            ...
            <a
              ...
              className="self-start mt-3 rounded-full ring-2 ring-orange-500 px-3 py-1 font-bold text-watermelon hover:bg-watermelon hover:text-white transition-colors"
            >
              {t("sandbox")}
            </a>
