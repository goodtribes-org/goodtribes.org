        ...
        <div ref={discoverRef} className="relative">
          ...
          {discover && (
            <div className="absolute top-full left-0 mt-1 bg-white border border-muted-teal rounded-xl shadow-lg py-1.5 min-w-48 z-50">
              ...
              {/* Idéverkstaden always redirects a logged-out visitor straight to
                  /login (see app/[locale]/ideaverkstad/page.tsx) — showing it
                  here for guests would be a nav item that only ever dead-ends. */}
              {session?.user && (
