...
import { createSandboxProject } from "./actions";
import FileUpload from "@/components/FileUpload";

export default function NewSandboxProjectForm() {
  ...
  return (
    <form action={createSandboxProject} className="flex flex-col gap-4">
      <textarea
        name="problem"
        rows={6}
        required
      ...
      <div className="flex gap-3">
        ...
        <a href="/sandbox" className="text-sm text-dark-slate/50 hover:text-dark-slate px-4 py-2">
          Avbryt
        </a>
      </div>
    </form>
