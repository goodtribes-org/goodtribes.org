...
import { updateValuePropositionDraftBlock } from "../actions";
...
export default function ValuePropositionDraftBlock({ draftId, field, side, label, hint, value, canEdit }: Props) {
  ...
  function handleSave(formData: FormData) {
    startTransition(async () => {
      await updateValuePropositionDraftBlock(draftId, field, formData);
      setEditing(false);
    });
  }
