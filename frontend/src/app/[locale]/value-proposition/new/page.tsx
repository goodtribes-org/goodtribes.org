...
import { createValuePropositionDraft } from "../actions";
import NewDraftForm from "@/components/NewDraftForm";

export const metadata: Metadata = {
  title: "Nytt värdeerbjudande — GoodTribes.org",
};

export default async function NewValuePropositionDraftPage({
  params,
}: {
  ...
  return (
    <div className="max-w-md mx-auto text-center py-16">
      ...
      <NewDraftForm
        action={createValuePropositionDraft}
