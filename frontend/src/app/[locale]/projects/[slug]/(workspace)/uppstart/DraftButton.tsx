...
import { startSkalaDrafts } from "../skala/actions";
import { startImpactDrafts } from "../impactfasen/actions";

const ACTIONS = {
  uppstart: startUppstartDrafts,
  lansering: startLanseringDrafts,
  etablera: startEtableraDrafts,
  skala: startSkalaDrafts,
  impact: startImpactDrafts,
};
