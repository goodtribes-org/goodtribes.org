...
export default function LeanCanvasHistory({ projectSlug }: { projectSlug: string }) {
  ...
  const FIELD_LABELS: Record<LeanCanvasField, string> = {
    ...
    vpJobs: t("fieldVpJobs"),
    vpPains: t("fieldVpPains"),
    vpGains: t("fieldVpGains"),
    vpProducts: t("fieldVpProducts"),
    vpRelievers: t("fieldVpRelievers"),
    vpCreators: t("fieldVpCreators"),
