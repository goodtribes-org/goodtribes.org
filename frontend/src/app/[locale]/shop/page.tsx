...
export const metadata: Metadata = {
  title: "Shop — GoodTribes.org",
  description: "Lös in dina GT mot belöningar.",
};
    ...
    <div className="max-w-4xl mx-auto">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-dark-slate/60 mt-1">Lös in dina GT mot belöningar.</p>
        </div>
        {userId && (
          <div className="text-right">
            <p className="text-xs text-dark-slate/50 uppercase tracking-wide">Ditt saldo</p>
      ...
      {items.length === 0 ? (
        <p className="text-sm text-dark-slate/40 italic">Inga varor i shopen än.</p>
      ) : (
      ...
      {userId && redemptions.length > 0 && (
        <div>
          <h2 className="text-sm font-semibold text-dark-slate mb-3">Din inlösenhistorik</h2>
