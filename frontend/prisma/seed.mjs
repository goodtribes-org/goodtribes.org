...
async function main() {
  ...
  const projectDefs = [
    { key: "renkust", slug: "ren-kust", title: "Ren Kust", org: orgs.natur, owner: u.elin, phase: "PRODUCTION", category: "Environment", legalType: "NONPROFIT_UMBRELLA",
    ...
    { key: "matsvinnapp", slug: "matsvinn-appen", title: "Matsvinn-appen", org: orgs.matsvinn, owner: u.erik, phase: "PILOT", category: "Environment", legalType: "NONPROFIT_UMBRELLA",
    ...
    { key: "digitalvag", slug: "digital-vagledning", title: "Digital Vägledning för Nyanlända", org: orgs.digital, owner: u.sara, phase: "IDEA", category: "Education", legalType: "NONPROFIT_UMBRELLA",
    ...
    { key: "kladbytardagen", slug: "kladbytardagen", title: "Klädbytardagen", org: orgs.klimat, owner: u.marcus, phase: "ESTABLISH", category: "Environment", legalType: "NONPROFIT_UMBRELLA",
    ...
    { key: "ungdomsjouren", slug: "ungdomsjouren-online", title: "Ungdomsjouren Online", org: orgs.roda, owner: u.linnea, phase: "PRODUCTION", category: "Health", legalType: "NONPROFIT_UMBRELLA",
    ...
    { key: "solceller", slug: "solceller-for-skolor", title: "Solceller för Skolor", org: null, owner: u.oskar, phase: "IDEA", category: "Environment", legalType: "NONPROFIT_UMBRELLA",
    ...
    { key: "mentorskap", slug: "mentorskap-ensamkommande", title: "Mentorskap för Ensamkommande", org: orgs.roda, owner: u.linnea, phase: "PILOT", category: "Community", legalType: "NONPROFIT_UMBRELLA",
    ...
    { key: "oppendata", slug: "oppen-data-klimat", title: "Öppen Data för Klimatinitiativ", org: null, owner: u.marcus, phase: "ESTABLISH", archived: true, category: "Technology", legalType: "NONPROFIT_UMBRELLA",
    ...
    { key: "skrapplockar", slug: "skrapplockar-appen", title: "Skräpplockar-appen", org: null, owner: u.nadia, phase: "ESTABLISH", category: "Environment", legalType: "NONPROFIT_UMBRELLA",
    ...
    { key: "gigplattformen", slug: "gigplattformen-for-goda-krafter", title: "Gigplattformen", org: null, owner: u.klara, phase: "PRODUCTION", category: "Technology", legalType: "COMMERCIAL_AB",
    ...
    { key: "greenbox", slug: "greenbox", title: "GreenBox", org: null, owner: u.viktor, phase: "PILOT", category: "Environment", legalType: "COMMERCIAL_AB",
    ...
    { key: "andrachansen", slug: "andra-chansen-mode", title: "Andra Chansen Mode", org: null, owner: u.noor, phase: "ESTABLISH", category: "Arts", legalType: "COMMERCIAL_AB",
    ...
    { key: "karriarkompassen", slug: "karriarkompassen", title: "KarriärKompassen", org: null, owner: u.klara, phase: "IDEA", category: "Technology", legalType: "COMMERCIAL_AB",
    ...
    { key: "laxhjalpendigital", slug: "laxhjalpen-digital", title: "Läxhjälpen Digital", org: orgs.laxhjalpen, owner: u.maja, phase: "PILOT", category: "Education", legalType: "NONPROFIT_UMBRELLA",
    ...
    { key: "muralprojektet", slug: "muralprojektet-i-fororten", title: "Muralprojektet i Förorten", org: orgs.konstkollektivet, owner: u.casper, phase: "PRODUCTION", category: "Arts", legalType: "NONPROFIT_UMBRELLA",
    ...
    { key: "samtalsjouren", slug: "samtalsjouren-for-aldre", title: "Samtalsjouren för Äldre", org: orgs.halsoframjarna, owner: u.ingrid, phase: "ESTABLISH", category: "Health", legalType: "NONPROFIT_UMBRELLA",
    ...
    { key: "tillganglig", slug: "tillganglig-kollektivtrafik", title: "Tillgänglig Kollektivtrafik", org: null, owner: u.rasoul, phase: "IDEA", category: "Technology", legalType: "NONPROFIT_UMBRELLA",
    ...
    { key: "katastrofberedskap", slug: "katastrofberedskap-volontar", title: "Katastrofberedskap Volontär", org: orgs.roda, owner: u.linnea, phase: "ESTABLISH", archived: true, category: "Community", legalType: "NONPROFIT_UMBRELLA",
    ...
    // -- Nya ideella projekt --
    { key: "bikupan", slug: "bikupan", title: "BiKupan", org: null, owner: u.amir, phase: "PILOT", category: "Environment", legalType: "NONPROFIT_UMBRELLA",
      sdgGoals: [15, 11], tags: ["biodling", "pollinatörer", "biologisk mångfald"],
      summary: "Ett nätverk av stadsbin och pollinatörsvänliga ytor som skyddar biologisk mångfald i tätbebyggda områden.",
      description: "BiKupan hjälper föreningar, skolgårdar och bostadsrättsföreningar att etablera bikupor och pollinatörsvänliga planteringar i städer. Vi erbjuder utbildning i biodling, lånar ut utrustning och för statistik över artrikedom på varje plats för att visa den konkreta effekten över tid." },
    { key: "vattenvakten", slug: "vattenvakten", title: "Vattenvakten", org: null, owner: u.oskar, phase: "PRODUCTION", category: "Environment", legalType: "NONPROFIT_OWN_ASSOC",
      sdgGoals: [6, 14], tags: ["vattenkvalitet", "medborgarforskning", "miljöövervakning"],
      summary: "Medborgarforskning där volontärer mäter vattenkvaliteten i svenska sjöar och vattendrag och delar resultaten öppet.",
      description: "Vattenvakten utbildar volontärer i enkla vattenprovtagningsmetoder och samlar in mätvärden från sjöar och åar runt om i landet. Data publiceras öppet och används av både forskare och kommuner för att upptäcka föroreningar tidigt, innan de blir stora problem." },
    { key: "foraldrakraft", slug: "foraldrakraft", title: "Föräldrakraft", org: null, owner: u.fatima, phase: "ESTABLISH", category: "Community", legalType: "NONPROFIT_UMBRELLA",
      sdgGoals: [3, 10], tags: ["föräldrastöd", "funktionsnedsättning", "gemenskap"],
      summary: "Ett peer-stödnätverk för föräldrar till barn med funktionsnedsättning, med lokala samtalsgrupper och en digital gemenskap.",
      description: "Föräldrakraft kopplar samman föräldrar som lever liknande vardagar genom lokala samtalsgrupper och en trygg digital plattform. Erfarna föräldrar utbildas till samtalsledare, och nätverket samarbetar med kommuner för att sprida information om vilket stöd som faktiskt finns att få." },
    { key: "kodklubben", slug: "kodklubben", title: "Kodklubben", org: null, owner: u.johan, phase: "PRODUCTION", category: "Education", legalType: "NONPROFIT_UMBRELLA",
      sdgGoals: [4, 10], tags: ["programmering", "utbildning", "digital kompetens"],
      summary: "Kostnadsfria kodklubbar efter skoltid för barn i områden med lägre socioekonomiska förutsättningar.",
      description: "Kodklubben driver återkommande, avgiftsfria programmeringsklubbar på fritidsgårdar och skolor. Volontära utvecklare leder passen, och barnen bygger allt från enkla spel till egna webbsidor. Målet är att digital kompetens inte ska vara en klassfråga." },
    { key: "skogsvakterna", slug: "skogsvakterna", title: "Skogsvakterna", org: orgs.natur, owner: u.yasmin, phase: "PILOT", category: "Environment", legalType: "NONPROFIT_OWN_ASSOC",
      sdgGoals: [15, 13], tags: ["återplantering", "skogsbruk", "klimatanpassning"],
      summary: "Volontärer planterar träd och övervakar skogshälsa i samarbete med lokala markägare och Naturskyddsföreningen.",
      description: "Skogsvakterna organiserar återplantering av kalhuggen skog och utbildar volontärer i att identifiera tecken på barkborreangrepp och torkstress. Projektet samarbetar tätt med lokala markägare för att både återställa mark och bygga upp kunskap om ett mer klimatanpassat skogsbruk." },
    { key: "tystnadenbryts", slug: "tystnaden-bryts", title: "Tystnaden Bryts", org: null, owner: u.ingrid, phase: "IDEA", category: "Community", legalType: "NONPROFIT_UMBRELLA",
      sdgGoals: [5, 16], tags: ["våld i nära relationer", "stödnätverk", "juridisk vägledning"],
      summary: "Ett stödnätverk och en digital resurs för personer som lever med eller lämnat en relation präglad av våld.",
      description: "Tystnaden Bryts bygger en anonym digital resurs med praktisk information, juridisk vägledning och kontaktvägar till skyddat boende, samtidigt som lokala stödgrupper leds av utbildade volontärer. Idén är fortfarande i tidigt skede och söker juridisk expertis och samarbete med befintliga kvinnojourer." },

    // -- Nya kommersiella projekt --
    { key: "ombytt", slug: "ombytt", title: "Ombytt", org: null, owner: u.noor, phase: "PRODUCTION", category: "Arts", legalType: "COMMERCIAL_AB",
      sdgGoals: [12], tags: ["klädlagning", "cirkulär ekonomi", "prenumeration"],
      summary: "En prenumerationstjänst för klädlagning och skräddarsydda ändringar som gör att kläder hålls längre.",
      description: "Ombytt skickar hem en lagningslåda varje månad eller kopplar kunden till en lokal skräddare, beroende på plagg och behov. Affärsidén är att göra det enklare att laga än att slänga — och att tjäna pengar på det. Tjänsten har redan över 500 betalande prenumeranter i Stockholmsregionen." },
    { key: "soldelat", slug: "soldelat", title: "SolDelat", org: null, owner: u.rasoul, phase: "PILOT", category: "Environment", legalType: "COMMERCIAL_UMBRELLA",
      sdgGoals: [7, 11], tags: ["solenergi", "energidelning", "lokalt elnät"],
      summary: "En marknadsplats där grannar med solpaneler kan sälja sitt överskottsel direkt till grannar utan egna paneler.",
      description: "SolDelat matchar hushåll med solcellsöverskott med grannar som saknar egna paneler, och sköter avräkning och betalning automatiskt via det lokala elnätet. Modellen gör solenergi mer tillgänglig utan att någon behöver investera i egen anläggning, och pilotprojektet testas just nu i tre bostadsområden utanför Uppsala." },
    { key: "kompetensbryggan", slug: "kompetensbryggan", title: "Kompetensbryggan", org: null, owner: u.klara, phase: "ESTABLISH", category: "Community", legalType: "COMMERCIAL_AB",
      sdgGoals: [8, 4], tags: ["mentorskap", "rådgivning", "småföretag"],
      summary: "Kopplar samman erfarna, pensionerade yrkesproffs med mindre företag som behöver rådgivning de annars inte kan finansiera.",
      description: "Kompetensbryggan förmedlar korta rådgivningsuppdrag mellan pensionerade specialister och småföretag inom bland annat ekonomi, juridik och marknadsföring. Företagen betalar en rimlig avgift, rådgivaren får betalt för sin tid, och plattformen tar en mindre serviceandel — en modell som redan visat sig bärkraftig efter det första året." },
    { key: "atterbruksbygg", slug: "aterbruksbygg", title: "Återbruksbygg", org: null, owner: u.viktor, phase: "PILOT", category: "Environment", legalType: "COMMERCIAL_AB",
      sdgGoals: [12, 11], tags: ["återbruk", "byggmaterial", "cirkulär ekonomi"],
      summary: "En digital marknadsplats för återvunnet byggmaterial som kopplar rivningsprojekt med byggare som vill återbruka.",
      description: "Återbruksbygg katalogiserar material från rivningsprojekt — allt från tegel till dörrar och armaturer — och gör det sökbart för byggare och privatpersoner som vill återbruka istället för att köpa nytt. Plattformen tar en förmedlingsavgift och siktar på att bli det självklara förstahandsvalet innan man river ett hus." },
    { key: "fiberdelning", slug: "fiberdelning", title: "Fiberdelning", org: null, owner: u.erik, phase: "IDEA", category: "Technology", legalType: "COMMERCIAL_UMBRELLA",
      sdgGoals: [9, 10], tags: ["bredband", "landsbygd", "kooperativ"],
      summary: "En kooperativ modell för att bygga och driva fiberbredband i glesbefolkade områden där de stora operatörerna inte satsar.",
      description: "Fiberdelning hjälper byalag att bilda ekonomiska föreningar som gemensamt gräver, äger och driftar sin egen fiberinfrastruktur, med rådgivning kring finansiering, upphandling och teknik. Idén bygger vidare på svenska byalagsmodellens starka tradition men med bättre digitala verktyg för medlemshantering och driftstatus." },
    { key: "klimatkontot", slug: "klimatkontot", title: "Klimatkontot", org: null, owner: u.marcus, phase: "PILOT", category: "Environment", legalType: "COMMERCIAL_AB",
      sdgGoals: [13], tags: ["klimatkompensation", "koldioxidbudget", "app"],
      summary: "En app som räknar ut din personliga koldioxidbudget och låter dig prenumerera på verifierad klimatkompensation för det som blir kvar.",
      description: "Klimatkontot kopplar till dina bank- och resedata för att automatiskt beräkna din klimatpåverkan och föreslår konkreta sätt att minska den. Det som inte går att minska går att kompensera för genom verifierade projekt, och appen tar en liten marginal på varje kompensationsköp. Piloten testas just nu med 200 användare." },
  ];
  const projects = {};
